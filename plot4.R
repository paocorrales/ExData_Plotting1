...
par(mfrow= c(2,2))
#Topleft plot
plot(DataEner[,10], DataEner[,3], type= "l", xlab= "", ylab="Global Active Power (Kilowatts)")
...
#Topright plot
plot(DataEner[,10], DataEner[,5], xlab= "datetime", ylab="Voltage", type= "l")

#Bottonright plot
plot(DataEner[,10], DataEner[,4], xlab= "datetime", ylab="Global_reactive_power", type= "l")
